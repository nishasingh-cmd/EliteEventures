...
const googleReviews = [
  { name: 'Sonam Yadav', time: '1 week ago', rating: 5, text: 'Sincere appreciation to the Elite Eventure team for outstanding support during our IICS booth setup! Special thanks to Nidhi for her proactive dedication and professionalism, and to Mukesh, Irshad, Narender, and Prince for their constant responsiveness. A truly dependable team—looking forward to future collaborations!', avatar: 'https://ui-avatars.com/api/?name=Sonam+Yadav&background=random' },
  ...
  { name: 'Sameer Mehta', time: '1 year ago', rating: 5, text: 'Team of Great Organizers professionally executing events without any chances of complaints. Great work, Keep it up' },
