...
const projects = [
  {
    ...
    img: '/images/pepe_jeans_stall.png',
    caption: 'Designed a high-impact interactive fashion booth and illuminated photo-box activation for the apparel trade show.',
    tag: 'Fashion & Retail',
  ...
  },
  {
    ...
    caption: 'Executed a premium backlit monolithic lightbox installation highlighting brand identity and modern minimalism.',
    tag: 'Fashion & Trade',
    objectPosition: 'center 35%',
  },
  {
    id: 3,
    brand: 'House of Cavalli',
    img: '/images/house_of_cavalli_stall.png',
    caption: 'Delivered an architectural LED display monolith with dynamic visual branding for luxury apparel showcases.',
    tag: 'Luxury & Apparel',
    objectPosition: 'center 35%',
  },
]
